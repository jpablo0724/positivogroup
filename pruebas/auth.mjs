...
console.log("\n== Roles y permisos ==");
{
  ...
  comprobar("nombre, apellidos, teléfono, cargo y correo, nada de rol ni permisos",
    JSON.stringify(Object.keys(equipoAna.cuerpo.equipo[0]).sort()) === JSON.stringify(["apellidos", "cargo", "email", "nombre", "telefono"]),
